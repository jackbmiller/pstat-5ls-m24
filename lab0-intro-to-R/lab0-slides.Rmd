...
Insert any information you want the students to know about you or about how sections will be run. 

For how sections are run, you might want to mention that sections will be a combination of labs that use R for data analysis and problem solving/Q&A sessions. 
...
For instance, you might have them remember the date and time that homework is due, and remind them that the deadlines are firm.
...
Each time we begin a lab, navigate to <https://bit.ly/pstat-5ls-m24>.

This will open your "instance" of JupyterHub and copy all necessary files for PSTAT 5LS labs. You will also find files to run statistical analyses for your homework here.

## Initial View of RStudio

Click on the 'pstat-5ls-m24' folder.
...
After you have clicked on the 'pstat-5ls-m24' folder, click on the folder for this lab (Lab 0).

Here's an example from a previous quarter:

\begin{center}
\includegraphics[width=10cm]{assets/images/RStudio-lab1-hw1-folder.png}
\end{center}

## Working with R in JupyterHub

When you navigate to <https://bit.ly/pstat5ls-m24>, you are telling JupyterHub to bring in all of the files that Professor Miller has in our PSTAT 5LS site. This means that files you have worked on will be overwritten.
...
-   Click Download and save the file on your computer in a folder you'll remember and be able to find later. You can just call the file `lab1-report-yourname.pdf` or whatever else you'd like (as long as you remember what you called it!).
